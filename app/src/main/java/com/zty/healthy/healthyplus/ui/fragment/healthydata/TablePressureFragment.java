...
import com.zty.healthy.healthyplus.adapter.PressureDataAdapter;
...
public class TablePressureFragment extends BaseFragment implements View.OnClickListener, DialogUtils.SavePressure {
    ...
    public void initData() {
        ...
        HealthyDataTitleUtils.setPressureTitle(context, layoutDataTitle);

        HealthyDataService.getData(context, Urls.getMonitorBpHistory, 2, PAGE_COUNT, this);
        ...
        recyclerTableData.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (mLastVisibleItemPosition > 0 && mLastVisibleItemPosition + 1 == pressureDataAdapter.getItemCount()) {
                        //已到达底部，开始加载更多
                        isLoadMore = true;
                        pressureDataAdapter.updateRefreshState(FooterRefreshAdapter.STATE_START);
                        PAGE_COUNT = mTempPageCount;
                        HealthyDataService.getData(context, Urls.getMonitorBpHistory, 2, PAGE_COUNT, TablePressureFragment.this);
                    }
                }
        ...
        pressureDataAdapter = new PressureDataAdapter(context, new ArrayList<PressureDataModel>());

        recyclerTableData.setAdapter(pressureDataAdapter);
        ...
        if (resultBean.isSuccess()) {
            ...
            switch (requestCode) {
                ...
                case 2:
                    ...
                    List<PressureDataModel> models = new Gson().fromJson(resultBean.getResult(), new TypeToken<List<PressureDataModel>>() {
                    }.getType());

                    pressureDataAdapter.notifyBottomRefresh(models);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnManual) {
            DialogUtils.pressureDialog(context, this);
        }
    }

    @Override
    public void saveListener(String hbp, String lbp, String heart) {
        ...
        if (!TextUtils.isEmpty(userId) && !TextUtils.isEmpty(familyUserId)) {
            ...
            RequestManager.post(1, Urls.sumbitMonitorBp, params, this);
