 ...
 */
package com.zty.healthy.healthyplus.db.util;


import com.zty.healthy.healthyplus.db.sqlite.annotation.Id;
import com.zty.healthy.healthyplus.db.sqlite.annotation.ManyToOne;
import com.zty.healthy.healthyplus.db.sqlite.annotation.OneToMany;
import com.zty.healthy.healthyplus.db.sqlite.annotation.Property;
import com.zty.healthy.healthyplus.db.sqlite.annotation.Transient;
		...
		try {
			...
			if (set != null) {
				...
				if (type == String.class) {
					...
					set.invoke(entity, value == null ? (Integer) null : Integer
						.parseInt(value.toString()));
				} else if (type == float.class || type == Float.class) {
					set.invoke(entity, value == null ? (Float) null: Float
						.parseFloat(value.toString()));
				} else if (type == long.class || type == Long.class) {
					set.invoke(entity, value == null ? (Long) null: Long
