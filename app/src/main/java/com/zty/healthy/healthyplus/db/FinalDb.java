package com.zty.healthy.healthyplus.db;
...
import com.zty.healthy.healthyplus.db.sqlite.CursorUtils;
import com.zty.healthy.healthyplus.db.sqlite.DbModel;
import com.zty.healthy.healthyplus.db.sqlite.ManyToOneLazyLoader;
import com.zty.healthy.healthyplus.db.sqlite.OneToManyLazyLoader;
import com.zty.healthy.healthyplus.db.sqlite.SqlBuilder;
import com.zty.healthy.healthyplus.db.sqlite.SqlInfo;
import com.zty.healthy.healthyplus.db.table.KeyValue;
import com.zty.healthy.healthyplus.db.table.ManyToOne;
import com.zty.healthy.healthyplus.db.table.OneToMany;
import com.zty.healthy.healthyplus.db.table.TableInfo;
import com.zty.healthy.healthyplus.db.util.ClassUtils;
...
public class FinalDb {
    ...
    public void save(Object entity) {
        Object id =ClassUtils.getPrimaryKeyValue(entity);
        if(id!=null){
    ...
    public void update(Object entity) {
        if(ClassUtils.getPrimaryKeyValue(entity)!=null){
            checkTableExist(entity.getClass());
...
///////////////////// 删除数据  //////////////////////////////////////////////
    ...
    public void delete(Object entity) {
        if(ClassUtils.getPrimaryKeyValue(entity)!=null){
            ...
            Log.e(TAG, "delete error: PrimaryKey is null");
        }
...
///////////////////// 查找数据  //////////////////////////////////////////////
        ...
        if (entity != null) {
            try {
                Collection<ManyToOne>
                        manys = TableInfo.get(clazz).manyToOneMap
                        .values();
        ...
        if (entity != null) {
            try {
                Collection<OneToMany>
                        ones = TableInfo.get(clazz).oneToManyMap
                        .values();
    ...
    public static class DaoConfig {
        ...
        private String mDbName = "healthyPlus.db"; // 数据库名字
