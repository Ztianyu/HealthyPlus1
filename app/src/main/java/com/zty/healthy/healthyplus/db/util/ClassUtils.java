...
import com.zty.healthy.healthyplus.db.DbException;
...
import com.zty.healthy.healthyplus.db.table.Property;
                ...
                if (!FieldUtils.isTransient(f) && FieldUtils.isOneToMany(f)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        throw new DbException(
                                "getOneToManyList Exception:" + f.getName() + "'s type is null");
                    }
